...
@Composable fun EnergyCore(modifier: Modifier) {
    val infinite = rememberInfiniteTransition(label="core"); val pulse by infinite.animateFloat(0.88f,1.12f,infiniteRepeatable(tween(1500, easing = FastOutSlowInEasing),RepeatMode.Reverse),label="pulse")
